...
3. Скопируй и выполни содержимое файла `supabase-schema.sql`
4. Нажми **Run**
...
Если у тебя есть права суперпользователя, можешь выполнить содержимое файла `STORAGE_POLICIES.sql` в SQL Editor. Но обычно это не работает для обычных пользователей.
